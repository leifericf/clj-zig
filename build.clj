(ns build
  ...
  CLOJARS_USERNAME and CLOJARS_PASSWORD, run by the maintainer. The git-dep
  coordinate keeps working for contributors regardless."
  (:require [clojure.tools.build.api :as b]
            [deps-deploy.deps-deploy :as dd]))

(def lib 'io.github.leifericf/clj-zig)
