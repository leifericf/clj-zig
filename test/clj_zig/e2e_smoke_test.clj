(ns clj-zig.e2e-smoke-test
  "Proves the compile-once fixtures all build and call. Loading
  `clj-zig.fixtures` compiles every native function; this calls each once so
...
(deftest struct-record-enum-fixtures-work
  ...
  (is (instance? clj_zig.fixtures.Vec2 (f/echo-vec2 (f/->Vec2 1.0 2.0))))
