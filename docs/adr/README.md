...
| [18](18-carrier-and-unsigned-policy.md) | Boundary carriers and the unsigned-return policy (FFM carrier limit) |
| [19](19-error-union-boundary-semantics.md) | Error-union boundary semantics (scalar, void, enum, or struct value) |
| [20](20-enum-boundary-semantics.md) | Enum boundary semantics (configurable backing width) |
...
| [43](43-nested-struct-fields-cross-by-value.md) | Nested struct fields cross by value |
| [44](44-slices-and-arrays-of-named-types.md) | Slices and arrays of named types cross in bulk |
